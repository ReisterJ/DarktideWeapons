...
namespace DarktideWeapons.Career
{
    ...
    /// <summary>
    /// Defines a single node in a career skill tree.
    /// May be a Perk (grants stat offsets) or a Skill (grants an active ability).
    /// Child nodes reference other DW_CareerNodeDef by defName in XML.
    /// </summary>
    public class DW_CareerNodeDef : Def
    {
        /// <summary>Whether this node is a passive perk or an active skill.</summary>
        public CareerNodeType nodeType = CareerNodeType.Perk;
        ...
        public List<DW_CareerNodeDef> childNodes;
    ...
    /// <summary>
    /// Defines a career available to pawns.
    /// Each career has a root node that leads to the rest of its skill tree.
    /// </summary>
    public class DW_CareerDef : Def
    {
        /// <summary>Root node of this career's skill tree.</summary>
        public DW_CareerNodeDef rootNode;

        /// <summary>Texture path for this career's icon shown in the gizmo.</summary>
        public string iconPath;
