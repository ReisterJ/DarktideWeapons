    ...
    public class DW_Bullet : Bullet
    {
        ...
        protected virtual void WeaponQuality_bias()
        {
            switch (this.equipmentQuality)
            {
                ...
                case QualityCategory.Masterwork:
                    this.critChanceinGame = this.DW_BulletDef.critChance * Util_Ranged.Quality_Master_Multiplier;
                    this.stunChanceinGame = this.DW_BulletDef.stunChance * Util_Ranged.Quality_Master_Multiplier;
                    break;
        ...
        protected virtual void Stunshot(Thing hitThing)
        {
            ...
            if (hitThing != null)
            {
                ...
                if (victim != null && Util_Ranged.CanBeStunned(victim, this.def.projectile.stoppingPower))
                {
                    if (Util_Ranged.IsStun(this.stunChanceinGame))
